...
<head>
    ...
    <title>Sobralnet - Ferramentas</title>
...
<body class="">
    <div class="wrapper ">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Ferramentas</a>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    ...
                                    <div class="float-right">
                                        <a href="#" data-toggle="modal" data-target="#exampleModalLongFerramenta">
                                            <i class="material-icons">
                                                add_circle
                                            </i>
                                        </a>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody class='result'>
                                                ...
                                                $query = "SELECT * FROM `ferramentas` WHERE fer_direcionamento = 'Ferramentas' LIMIT 20";
                                 ...
                                 <td class='text-center'><a href='#' class='editar_fer' id='$id'><i class='fa fa-pencil-square' aria-hidden='true'></i></a></td>
					<td class='text-center'><a href='#' onClick='apagar_ferramenta($id)'><i class='fa fa-trash' aria-hidden='true'></i></a></td>
                              </tr>";
                                                }
                                                ?>
                                            </tbody>
            ...
            <!-- Modal Ferramentas-->
            <div class="modal fade" id="exampleModalLongFerramenta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLong" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title text-center" id="exampleModalLongTitlePreencher">Adicionar Ferramentas</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="../../../controle/adicionar/adicionar_ferramentas.php" method="POST">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1Ferramenta">Descrição da Ferramenta</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1Ferramenta" required="required" name="descricao">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1Tipo">Autorização</label>
                                    <select class="form-control" id="exampleFormControlSelect1Tipo" name="tipo">
                                        ...
                                        <option value="5">Para todos</option>
                                    </select>
                                </div>
                        </div>
            ...
            <!-- Modal editar Ferramentas -->
            <div class="modal fade" id="ModalEditarFer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLong" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title text-center" id="exampleModalLongTitlePreencher">Editar Ferramenta</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="../../../controle/atualizar/atualizar.php?atualizar=fer" method="POST">
                                <div id="retornar_fer">
    ...
    <!--   Js   -->
    <script src="../../../model/atualizar/editar.js"></script>
    ...
    <script>
        $(function() {
            $("#pesquisa").keyup(function() {
                ...
                if (pesquisa != '') {
                    ...
                    $.post('pesquisar/pesquisar_fer.php', dados, function(retorna) {
        ...
        $(document).ready(function() {
            $(document).on('click', '.editar_fer', function() {
                var fer_id = $(this).attr("id");
                // alert(fer_id);
                // Verificar se há valor na variável "fer_id".
                if (fer_id !== '') {
                    var dados = {
                        fer_id: fer_id
                    };
                    $.post('dados/dados_fer.php', dados, function(retorna) {
                        //Carregar o conteúdo para o usuário
                        $("#retornar_fer").html(retorna);
                        $('#ModalEditarFer').modal('show');
                    });
                }
            });
        });
