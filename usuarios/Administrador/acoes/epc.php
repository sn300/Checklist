...
<body class="">
    <div class="wrapper ">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Epc´s</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title ">Epc´s</h4>
                                    <p class="card-category">Descrição e autorizações</p>
                                    <div class="float-right">
                                        <a href="#" data-toggle="modal" data-target="#exampleModalLongEpc" data-toggle="modal" data-target="#exampleModalLongEpcs">
                                            <i class="material-icons">
                                                add_circle
                                            </i>
                                        </a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody class='result'>
                                                ...
                                                $query = "SELECT * FROM `ferramentas` WHERE fer_direcionamento = 'Epc'";
            ...
            <!-- Modal Epc´s-->
            <div class="modal fade" id="exampleModalLongEpc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLong" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title text-center" id="exampleModalLongTitlePreencher">Adicionar Epc´s</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="../../../controle/adicionar/adicionar_epc.php" method="POST">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1Ferramenta">Descrição do Epc</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1Ferramenta" required="required" placeholder="Descrição" name="descricao">
                                </div>
                                <div class="form-group">
            ...
            <!-- Modal editar Epi´s-->
            <div class="modal fade" id="ModalEditarEpc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLong" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title text-center" id="exampleModalLongTitlePreencher">Atualizar Epc´s</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="../../../controle/atualizar/atualizar.php?atualizar=epc" method="POST">
                                <div id="retornar_epc">
        ...
        $(function() {
            $("#pesquisa").keyup(function() {
                ...
                if (pesquisa != '') {
                    ...
                    $.post('pesquisar/pesquisar_epc.php', dados, function(retorna) {
            ...
            $(document).on('click', '.editar_epc', function() {
                var epc_id = $(this).attr("id");
                // alert(epc_id);
                ...
                if (epc_id !== '') {
                    ...
                    $.post('dados/dados_epc.php', dados, function(retorna) {
                        //Carregar o conteúdo para o usuário
                        $("#retornar_epc").html(retorna);
                        $('#ModalEditarEpc').modal('show');
                    });
                }
            });
        });
