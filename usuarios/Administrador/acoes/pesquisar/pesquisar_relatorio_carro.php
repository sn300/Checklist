<?php
session_start();
if (!isset($_SESSION['usu_email']) or !isset($_SESSION['usu_senha']) || $_SESSION['usu_tipo'] <> "1" || !isset($_POST['pesquisa2'])) {
  header('Location: ../../../../');
}
?>
<!DOCTYPE html>
...
<body class="">
  <div class="wrapper ">
    ...
    <ul class="navbar-nav">
            <li class="nav-item">              
              <form class="navbar-form" method="POST" id="form-pesquisa2" action="pesquisar_relatorio_carro.php">
              <div class="input-group no-border">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Todos os relatórios da PLACA:  <?php echo $_POST['pesquisa2'];?></h4>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody  class='result'>
                        ...
                        INNER JOIN automoveis ON automoveis_auto_id = auto_id WHERE  auto_placa = '$auto_placa2' ORDER BY `transacao`.`tra_data` DESC";
