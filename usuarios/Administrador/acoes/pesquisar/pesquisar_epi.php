...
$result_user = "SELECT * FROM ferramentas WHERE fer_descricao LIKE '%$descricao%' AND fer_direcionamento ='Epi'";
...
<td class='text-center'><a href='#' onClick='apagar_epi($id)'><i class='fa fa-trash' aria-hidden='true'></i></a></td>
</tr>";
                        }
                    }else{
	echo "<center><td class='text-center'>Nenhum registro encontrado ...</td></center>";
}
 echo "<script src='../../../../model/atualizar/editar.js'></script>";
 echo "<script src='../../../../model/deletar/js/deletar.js'></script>";
?>
