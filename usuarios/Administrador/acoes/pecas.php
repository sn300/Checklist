...
<body class="">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Peças</a>
          </div>
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <div class="float-right">
                    <a href="#" data-toggle="modal" data-target="#exampleModalLongPecas">
                      <i class="material-icons">
                        add_circle
                      </i>
                    </a>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody class='result'>
                        ...
                        $query = "SELECT * FROM `pecas` LIMIT 20";
      ...
      <!-- Modal adicionar Peças-->
      <div class="modal fade" id="exampleModalLongPecas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLong" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-center" id="exampleModalLongTitlePreencher">Adicionar Peças</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="../../../controle/adicionar/adicionar_pecas.php" method="POST">
                <div class="form-group">
                  <label for="exampleFormControlInput1Pecas">Descrição da Peça</label>
                  <input type="text" class="form-control" id="exampleFormControlInput1Pecas" required="required" placeholder="Descrição" name="descricao">
                </div>
                <div class="form-group">
      ...
      <!-- Fim do Modal -->
      <!-- Modal editar Peças-->
      <div class="modal fade" id="ModalEditarPeca" tabindex="-1" role="dialog" aria-labelledby="exampleModalLong" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title text-center" id="exampleModalLongTitlePreencher">Atualizar Peças</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form action="../../../controle/atualizar/atualizar.php?atualizar=pecas" method="POST">
                <div id="retornar_peca"></div>
  ...
  <script>
    $(function() {
      $("#pesquisa").keyup(function() {
        ...
        if (pesquisa != '') {
          ...
          $.post('pesquisar/pesquisar_peca.php', dados, function(retorna) {
    ...
    $(document).ready(function() {
      $(document).on('click', '.editar_pe', function() {
        var pe_id = $(this).attr("id");
        // alert(pe_id);
        // Verificar se há valor na variável "pe_id".
        if (pe_id !== '') {
          var dados = {
            pe_id: pe_id
          };
          $.post('dados/dados_peca.php', dados, function(retorna) {
            //Carregar o conteúdo para o usuário
            $("#retornar_peca").html(retorna);
            $('#ModalEditarPeca').modal('show');
          });
        }
      });
    });
