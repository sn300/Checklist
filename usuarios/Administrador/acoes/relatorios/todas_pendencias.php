...
$pdf->SetFont('Arial', 'B', 16);
 $pdf->Ln(5);
$pdf->Image('../../../../images/logo.png',125,1,33);

$pdf->SetFont("Arial","b",11);
$pdf->Cell(45,7,"Nome",1,0,"c");
$pdf->Cell(45,7,"Cidade",1,0,"c");
$pdf->Cell(30,7,utf8_decode("Automóvel"),1,0,"c");
$pdf->Cell(40,7,"Placa",1,0,"c");
$pdf->Cell(40,7,utf8_decode("Direcionamento"),1,0,"c");
$pdf->Cell(40,7,utf8_decode("Situação"),1,0,"c");
$pdf->Ln();
...
$pdf->Cell(45,7,utf8_decode($dados["usu_nome"]),1,0,"c");
$pdf->Cell(45,7,utf8_decode($dados["usu_cidade"]),1,0,"c");
$pdf->Cell(30,7,utf8_decode($dados["auto_modelo"]),1,0,"c");
$pdf->Cell(40,7,utf8_decode($dados["auto_placa"]),1,0,"c");
$pdf->Cell(40,7,utf8_decode($dados["pe_descricao"]),1,0,"c");
$pdf->Cell(40,7,utf8_decode($dados["tran_pe_condicao"]),1,0,"c");
$pdf->Ln();
                          }
...
$pdf->Cell(30,7,utf8_decode($dados["auto_modelo"]),1,0,"c");
$pdf->Cell(40,7,utf8_decode($dados["auto_placa"]),1,0,"c");
$pdf->Cell(40,7,utf8_decode($dados["fer_descricao"]),1,0,"c");
$pdf->Cell(40,7,utf8_decode($dados["fer_has_transacao_descricao"]),1,0,"c");
$pdf->Ln();
 }
 $pdf->AddPage();
    $pdf->Output();
