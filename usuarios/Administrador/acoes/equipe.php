...
<head>
    ...
    <title>Sobralnet - Nossa Equipe</title>
    <meta content="width=device-width, initial-scale=1.0, shrink-to-fit=no" name="viewport">
    <!--     Fonts and icons     -->
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Roboto+Slab:400,700|Material+Icons">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">
    <!-- CSS Files -->
    <link rel="stylesheet" href="../../../default/css/material-dashboard.css" >
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand text-center" href="javascript:;">Nossa Equipe</a>
                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="card card-profile">
                                    <div class="card-avatar">
                                        <img id="fotoa" class="img" src="../../../images/perfil/<?php echo $img; ?>">
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title"><?php echo $nome; ?></h4>
                                        <a href="#" class="btn btn-primary btn-round"><?php echo $aux[$tipo]; ?></a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
